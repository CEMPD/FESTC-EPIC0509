...
#foreach SCEN ("FML_2022_HI_HG_TD_MG_413_0acres_grass" "base_2022_HI_HG_TD_MG_413_0acres_grass" )
...
foreach spc ( T_YLDG T_YLDF ) #3N FNO3 YLN FNO FNH3 3N YLN NFIX TOC FNO FNO3 FNH3 T_YLDG T_YLDF )

# set regions to be used in summary any of "FIPS HUC8 REG10"
foreach reg ( HUC2 STFIPS ) #items: HUC1 HUC2 STFIPS FIPS HUC8 REG10  
  setenv SPC  $spc
  setenv REG  $reg
