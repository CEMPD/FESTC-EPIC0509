...
plot (fepic$PLANT_CROP,cumarea,main=c("Irrigated",RegionName[j],CropName[i],"Plant Dates"),col=("red"),pch="",xlab="Week Ending Julian Day",
...
plot (fepic$PLANT_CROP,cumarea,main=c("Rainfed",RegionName[j],CropName[i],"Plant Dates"),col=("red"),pch="",xlab="Week Ending Julian Day",
ylab="Fraction of Area Plant", ylim=c(ad,ab),xlim=c(ae,ac))
lines(fepic$PLANT_CROP,cumarea,col=("red"),lwd=c(2,2))
