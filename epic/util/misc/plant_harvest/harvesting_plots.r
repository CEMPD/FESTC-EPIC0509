...
plot (fepic$PLANT_CROP,cumarea,main=c("State Irrigated",StateName[j],CropName[i],"Harvest Dates"),col=("red"),pch="",xlab="Week Ending Julian Day",
...
plot (fepic$PLANT_CROP,cumarea,main=c("State Rainfed",StateName[j],CropName[i],"Harvest Dates"),col=("red"),pch="",xlab="Week Ending Julian Day",
#ylab="Fraction of Area Plant", ylim=c(ad,ab),xlim=c(ae,ac))
 ylab="Fraction of Area Harvest", ylim=c(ad,ab),xlim=c(ae,ac))
lines(fepic$PLANT_CROP,cumarea,col=("red"),lwd=c(2,2))
